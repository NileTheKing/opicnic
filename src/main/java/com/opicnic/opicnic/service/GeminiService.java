...
public class GeminiService {
    ...
    private static final String SYSTEM_PROMPT =
            "당신은 OPIc 시험 전문 평가자입니다. 모든 텍스트 필드는 반드시 한국어로만 작성하세요.\n" +
                    ...
                    "TYPE_1(묘사): MP + 감각적 형용사 기반 설명 + 결론\n" +
                    "TYPE_2(루틴): MP + Before→But now 비교 + 결론\n" +
                    "TYPE_3(과거경험): MP(경험 핵심) + 스토리 + 결론\n" +
                    "TYPE_4(기억에 남는 경험): MP(왜 기억에 남는지) + 감정+상황 + 결론\n" +
                    "TYPE_5(질문하기): 자연스러운 질문 3개, 각각 다른 표현\n" +
                    "TYPE_6(전화/정보 요청): 상황 설명 + 요청사항 명확히\n" +
                    "TYPE_7(문제 해결): 문제 인식 + 대안 2개 이상\n" +
                    "TYPE_8(비슷한 경험): MP + 스토리 + 결론\n" +
                    "TYPE_9(비교): MP(변화 방향) + 과거→현재 + 결론\n" +
                    "TYPE_10(이슈): MP + A관점 + B관점 + 결론\n" +
                    "\n" +
